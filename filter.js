...
const hommes = document.querySelectorAll(".homme");
const femmes = document.querySelectorAll(".femme");
const title = document.getElementById("page-title");

if (category === "hommes") {
  title.textContent = "Montres pour Hommes";
  femmes.forEach(el => el.style.display = "none");
}

if (category === "femmes") {
  title.textContent = "Montres pour Femmes";
  hommes.forEach(el => el.style.display = "none");
}
